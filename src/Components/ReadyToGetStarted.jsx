...
const ReadyToGetStarted = ({ id }) => {
  ...
  const handleButtonClick = () => {
    ...
    const body = encodeURIComponent("Hi, I am interested in your services. Let's get in touch.");
    
    // Generate the mailto link
    const mailtoLink = `mailto:${randomEmail}?subject=${subject}&body=${body}`;
    
    // Open the email client with the generated mailto link
